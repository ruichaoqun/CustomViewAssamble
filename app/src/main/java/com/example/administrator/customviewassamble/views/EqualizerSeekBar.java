...
public class EqualizerSeekBar extends View {
    ...
    private void init(Context context) {
        mTopPadding = UIUtils.dip2px(context,30.0f);
        mLineStrokeWidth = UIUtils.dip2px(context, 2.0f);
        mLargeLineWidth = UIUtils.dip2px(context, 15.0f);
        mSmallLineWidth = UIUtils.dip2px(context, 7.5f);
        mThumbRadio = UIUtils.dip2px(context, 12.5f);
        mThumbLineWidth = UIUtils.dip2px(context, 12.0f);
        mThumbLineDividerWidth = UIUtils.dip2px(context, 4.5f);
        mThumbShadowWidth = UIUtils.dip2px(context, 2.0f);
        mTextBackgroundHeight = UIUtils.dip2px(context, 20.0f);
        mTextPadding = UIUtils.dip2px(context, 3.0f);
        ...
        mThumbLinePaint.setStrokeWidth(UIUtils.dip2px(context, 1.3f));
        ...
        mTextPaint.setTextSize(UIUtils.sp2px(context, 12.0f));
